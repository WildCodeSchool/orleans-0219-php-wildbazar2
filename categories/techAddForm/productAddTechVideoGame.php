...
<div class="container mt-5 mb-5">
    <h1 class="form-title">Add some new Video-Games products :</h1>
    <form method="post" enctype="application/x-www-form-urlencoded" class="product-form mt-5">
