				...
				<div class="row justify-content-space-around">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-2 offset-1">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-text"><?php echo $productDescription['shorttitle'];?></h5>
                                <p class="price"><?php echo $productDescription['Price'];?> &euro;</p>
                                <a href="#" class="btn" id="categoryBtn">
                                    <i class="fas fa-cart-plus"></i>
                                    Add to cart
                                </a>
                                <button type="button" data-toggle="modal" data-toggle="tooltip" data-target="#<?php echo $productDescription['id'];?>" class="btn btnInfo" data-placement="bottom" title="More details">
                    ...
                    <div class="modal fade" id="<?php echo $productDescription['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle"><?php echo $productDescription['longtitle'];?></h5>
                                     <h3> <?php echo $productDescription['Price'];?> &euro;</h3>
                                ...
                                <div class="modal-body row">
                                    <div class="card col-sm-6 modalImg">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="carac">
                                                <li><span class="bold">Size :</span> <?php echo $productDescription['size'];?></li>
                                                <li><span class="bold">Power :</span> <?php echo $productDescription['power'];?></li>
                                                <li><span class="bold">Color :</span> <?php echo $productDescription['color'];?></li>
                                            </ul>
                                        </div>
                                    </div>
