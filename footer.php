    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6">
            <div class="row tableFooter">
                <div class="col-12 col-sm-6 col-md-6 col-lg-4"> <a href="/index.php#home"> Home </a> </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-4"> <a href="/categoriesfashion.php">Fashion</a></div>
            </div>
            <div class="row tableFooter">
            ...
            <div class="row tableFooter">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4"> <a href="/categories/watches-items.php">Watches</a></div>
            </div>
            <div class="row tableFooter">
