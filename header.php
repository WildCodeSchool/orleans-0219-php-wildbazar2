		...
		<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<a href="#home">
					<img class="carousel_image homeImg" src="/images/banner_image_original_1509469545.jpg" class="d-block w-100" alt="commercial image">
					</a>
			...
			<div class="carousel-item">
				<a href="/categories/aquarium.php">
			...
			<div class="carousel-item">
				<a href="fashion.php">	
				<img class="carousel_image homeImg" src="/images/fashion3.jpg" alt="wears">
				</a>
				<div class="carousel-caption d-none d-md-block">
			...
			<div class="carousel-item">
				...
				<img class="carousel_image homeImg" src="/images/montres.jpg" alt="watch">
				</a>
				<div class="carousel-caption d-none d-md-block">
			...
			<img class="carousel_image homeImg" src="/images/tech.jpg" alt="computer">
			</a>
				<div class="carousel-caption d-none d-md-block">
			...
			<div class="carousel-item">
				...
				<img class="carousel_image homeImg" src="/images/cuisine.jpg" alt="kitchen">
				</a>
				<div class="carousel-caption d-none d-md-block">
